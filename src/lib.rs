...
#![cfg_attr(clippy, warn(cast_sign_loss))]
#![cfg_attr(clippy, warn(mut_mut))]
#![cfg_attr(clippy, warn(mutex_integer))]
#![cfg_attr(clippy, warn(non_ascii_literal))]
#![cfg_attr(clippy, warn(option_unwrap_used))]
#![cfg_attr(clippy, warn(print_stdout))]
#![cfg_attr(clippy, warn(result_unwrap_used))]
#![cfg_attr(clippy, warn(single_match_else))]
#![cfg_attr(clippy, warn(string_add))]
#![cfg_attr(clippy, warn(string_add_assign))]
#![cfg_attr(clippy, warn(unicode_not_nfc))]
#![cfg_attr(clippy, warn(wrong_pub_self_convention))]
